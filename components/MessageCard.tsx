                        ...
                        <div className="relative z-10">
                          ...
                          <div className="handwriting text-sm sm:text-base leading-relaxed text-[#1b0d14] pb-20 pt-6">
                            <div className="mb-4 text-[#f04299] font-medium">
                              My dearest Rashubabu,
                            </div>
                            <div
                              className="mb-6 text-justify"
                              style={{ textIndent: '2rem' }}
                            >
                              My love, every mile between us only strengthens my heart. 
                              I feel you in every sunrise and whisper your name in every star. 
                              Though distance keeps us apart, our love bridges the space. 
                              I cherish you endlessly and dream of the day we’re together, never apart again.
                            </div>
